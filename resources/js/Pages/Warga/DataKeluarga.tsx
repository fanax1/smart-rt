        ...
        <WargaLayout profile={safeProfile} title="Data Keluarga">
            ...
            <div className="mx-auto max-w-6xl space-y-6 px-4 py-6 lg:px-8 lg:py-8">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-xl font-black text-slate-900 tracking-tight">Informasi Kartu Keluarga</h1>
                        <p className="text-xs text-slate-600 mt-0.5 font-medium">
                            Nomor KK: <span className="font-mono text-emerald-700 font-bold">{kartuKeluarga?.noKK || '-'}</span>
                        </p>
                    </div>
                </div>

                {/* Banner Verification Notice */}
                <div className="rounded-2xl border border-emerald-200 bg-emerald-50 p-4 flex flex-col md:flex-row gap-4 items-start md:items-center justify-between">
                    <div className="flex gap-3">
                        <div className="mt-0.5 md:mt-0 flex h-7 w-7 items-center justify-center rounded-lg bg-emerald-100 text-emerald-700 border border-emerald-200 shrink-0">
                            <CheckCircle size={15} />
                        </div>
                        <div>
                            <p className="text-xs font-black text-emerald-900">Profil Terverifikasi</p>
                            <p className="text-[11px] text-slate-700 font-medium leading-relaxed mt-0.5 max-w-3xl">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        {headOfFamily ? (
                            <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm relative overflow-hidden group">
                                <div className="flex flex-col md:flex-row items-center md:items-start gap-6 pb-6 border-b border-slate-200">
                                    <div className="flex h-24 w-24 shrink-0 items-center justify-center overflow-hidden rounded-2xl border border-emerald-200 bg-emerald-50 shadow-sm">
                                        <span className="text-2xl font-black text-emerald-700">{getInitials(headOfFamily.nama)}</span>
                                    </div>
                                    
                                    <div className="text-center md:text-left space-y-2 flex-1 min-w-0">
                                        <div className="flex flex-col md:flex-row md:items-center gap-2">
                                            <h2 className="text-lg font-black text-slate-900 truncate">{headOfFamily.nama}</h2>
                                            <span className="bg-emerald-50 text-emerald-700 border border-emerald-200 rounded-md px-2 py-0.5 text-[10px] font-extrabold tracking-wide uppercase self-center md:self-auto">
                                                Kepala Keluarga
                                            </span>
                                        </div>
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-2 pt-2 text-xs">
                                            <div className="flex items-center gap-2">
                                                <span className="text-slate-500 w-24 shrink-0 font-medium">NIK</span>
                                            ...
                                            <div className="flex items-center gap-2">
                                                <span className="text-slate-500 w-24 shrink-0 font-medium">Pekerjaan</span>
                                                <span className="text-slate-900 truncate font-semibold">{headOfFamily.pekerjaan || '-'}</span>
                                            </div>

                                            <div className="flex items-center gap-2 md:col-span-2">
                                                <span className="text-slate-500 w-24 shrink-0 font-medium">Tempat/Tgl Lahir</span>
                            ...
                            <div className="rounded-3xl border border-dashed border-slate-200 p-8 text-center text-xs text-slate-500 bg-white shadow-sm">
                    ...
                    <div>
                        <div className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm flex flex-col h-full justify-between">
                            <div>
                                <div className="flex items-center justify-between mb-4 pb-3 border-b border-slate-200">
                                    <div className="flex items-center gap-2">
                                        <Users size={16} className="text-emerald-600" />
                                        <h3 className="text-xs font-black text-slate-900 uppercase tracking-wider">Daftar Anggota</h3>
                                    </div>
                                    <span className="bg-slate-100 text-slate-700 border border-slate-200 rounded-full px-2 py-0.5 text-[9px] font-extrabold uppercase">
                                ...
                                <div className="space-y-3">
                                    {otherMembers.length === 0 ? (
                                        <div className="text-center py-6 text-xs text-slate-500 border border-dashed border-slate-200 rounded-2xl">
                                                ...
                                                >
                                                    ...
                                                    >
                                                        <div className="flex items-center gap-3 min-w-0">
                                                            <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-white border border-slate-200 text-xs font-bold text-slate-700 shadow-sm">
                                                                {getInitials(member.nama)}
                                                            </div>
                                                            <div className="min-w-0">
                                                                <p className="truncate text-xs font-bold text-slate-900">{member.nama}</p>
                                                        ...
                                                        <div className="flex items-center gap-2 shrink-0">
                                                            <span className={`inline-flex items-center gap-1 rounded-md px-1.5 py-0.5 text-[9px] font-extrabold tracking-wide uppercase ${
                                                                ...
                                                                {hasFullData ? 'Lengkap' : 'Perlu Detail'}
                                                            </span>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm flex flex-col justify-between relative overflow-hidden">
                        <div>
                            <div className="flex items-center justify-between mb-4">
                                <h3 className="text-xs font-black text-slate-900 uppercase tracking-wider">Ringkasan Verifikasi</h3>
                            </div>
                        ...
                        <div className="border-t border-slate-200 pt-4 mt-6 flex justify-between items-center relative">
                            <Link href="/warga/profil" className="inline-flex items-center gap-1.5 text-xs font-bold text-slate-700 hover:text-emerald-700 transition">
                    ...
                    <div className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm flex flex-col justify-between">
                        <div>
                            <div className="flex items-center justify-between mb-4">
                                <h3 className="text-xs font-black text-slate-900 uppercase tracking-wider">Aktivitas Terakhir</h3>
                            </div>
                            ...
                            <div className="space-y-4">
                                {activities.length === 0 ? (
                                    ...
                                    activities.slice(0, 2).map((log, idx) => (
                                        <div key={log.id || idx} className="flex gap-3 items-start text-xs border-b border-slate-100 pb-3 last:border-none last:pb-0">
                                            <div className="mt-0.5 flex h-7 w-7 items-center justify-center rounded-lg bg-slate-100 text-emerald-700 border border-slate-200 shrink-0">
                                                <Activity size={12} />
                                            </div>
                                            <div className="min-w-0 flex-1 space-y-0.5">
                                                <p className="font-bold text-slate-900 leading-tight">{log.title}</p>
                                                <p className="text-[10px] text-slate-600 font-medium leading-normal">{log.description}</p>
